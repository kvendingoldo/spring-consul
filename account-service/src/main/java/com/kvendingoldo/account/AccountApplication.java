package com.kvendingoldo.account;

import com.kvendingoldo.account.model.Account;
import com.kvendingoldo.account.repository.AccountRepository;
...
public class AccountApplication {
	...
	AccountRepository repository() {
		...
		repository.add(new Account("1234567899", 50000, 3L));
		return repository;
	}
